...
Begin VB.Form ProformaAnt 
   ...
   Begin MSAdodcLib.Adodc Adodc1 
      ...
      UserName        =   "root"
      Password        =   "cagisa"
      RecordSource    =   "Select * from cabproforma order by cegr_id"
      Caption         =   "Adodc1"
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "MS Sans Serif"
         Size            =   8.25
   ...
   Begin VB.Image Image1 
      Height          =   60
      Left            =   6390
      Picture         =   "ProformaAnt.frx":002A
      Stretch         =   -1  'True
      Top             =   450
      Width           =   6540
   End
End
Attribute VB_Name = "ProformaAnt"
...
vnumpro = SSOleDBGrid1.Columns(0).Value
vcliente = SSOleDBGrid1.Columns(2).Value

reporte = "INSERT INTO repproforma SELECT * FROM detproforma WHERE cegr_id = " & vnumpro
Cn.Execute reporte
...
Menup.Enabled = True
Unload ProformaAnt
Set ProformaAnt = Nothing
End Sub

Private Sub SSOleDBGrid1_Click()
vpro_id = SSOleDBGrid1.Columns(0).Value
Adodc3.RecordSource = "Select * from detproforma where cegr_id = " & vpro_id
Adodc3.Refresh
seleccion = 1
